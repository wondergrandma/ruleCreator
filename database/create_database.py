...
engine = create_engine(database_config.POSTGRE_DIALECT+'+'+database_config.POSTGRE_DRIVER+'://'+database_config.POSTGRE_USERNAME+':'+database_config.POSTGRE_PASSWORD+'@'+database_config.POSTGRE_HOST+':'+database_config.POSTGRE_PORT+'/'+database_config.POSTGRE_DATABASE_NAME, echo = True)
